...
-3.163861346935494723e+01,
-3.162199619083257573e+01,
};
static double array_cof_float_sf_airy_Bi_deriv_scaled_0[1][8] = {
{
...
static double array_cof_err_sf_airy_Bi_deriv_scaled_0[1][8] = {
{
