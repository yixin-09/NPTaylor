#include "eft_patch.h"
static double array_idx_sf_airy_Ai_0[2] = {
-2.375169042693394488e+02,
-2.375027670539664939e+02,
};
static double array_cof_float_sf_airy_Ai_0[1][8] = {
{
...
static double array_cof_err_sf_airy_Ai_0[1][8] = {
{
...
static double array_point_sf_airy_Ai_0[1] = {
-2.375098356614411443e+02,
};
static double array_cofidx_sf_airy_Ai_0[1] = {
